<div class="wrap">
    <h1><?php echo esc_html(get_admin_page_title()); ?><a href="admin.php?page=app_guiafloripa_push_add" class="page-title-action">Criar</a></h1>
    <div class="notice notice-info"> 
        <p>Lista de <code>Notificações</code>.</p>
    </div>
