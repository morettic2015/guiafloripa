 ...
 */
require dirname(__FILE__) . '/TwitterGrid.php';
 ...
 */
function tt_render_twitter_page() {
    // Create an instance of our package class.
    $twtbot = new TwitterGrid();

    // Fetch, prepare, sort, and filter our data.
    $twtbot->prepare_items();

    // Include the view markup.
    include dirname(__FILE__) . '/tpage.php';
}

tt_render_twitter_page();
?>
